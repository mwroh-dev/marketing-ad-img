...
- @${CLAUDE_PLUGIN_ROOT}/agents/copy-analyst.md → @${CLAUDE_PLUGIN_ROOT}/schemas/analysis/copy-analysis.schema.json
  Consumes your `text_elements[].content`. Owns the **text/copy meaning** (roles, hook, keywords). ← NOT yours.
- @${CLAUDE_PLUGIN_ROOT}/agents/layout-analyst.md → @${CLAUDE_PLUGIN_ROOT}/schemas/analysis/layout-analysis.schema.json
  Consumes your `bbox` / `font_size_scale` / `graphic_elements` / `canvas`. Owns the **spatial/layout meaning**. ← NOT yours.
- @${CLAUDE_PLUGIN_ROOT}/agents/visual-analyst.md → @${CLAUDE_PLUGIN_ROOT}/schemas/analysis/visual-analysis.schema.json
