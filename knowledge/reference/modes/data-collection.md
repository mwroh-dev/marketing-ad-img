...
2. **Collect** with `mcp__plugin_marketing-img_m__collection_run_flow` — Meta Ad Library keyword search returns real ads broadly (not advertiser-bound). Union/dedup across queries. Writes the dated run + `run.json` (stage=collected).
